export default function Contact() {
    return (
        <section className="bg-zinc-200">
            <div className="flex flex-col justify-between mx-auto bg-zinc-200 max-w-[1250px] py-2 px-1 lg:px-6">
            ...
            <div className="w-full bg-blue-500">
                <div className="relative bg-blue-500 flex flex-col items-center mx-auto max-w-[1250px] py-4 px-1 md:items-start lg:px-6">
                    ...
                    <div className="bg-white flex flex-col gap-4 card-shadow rounded-lg py-4 px-8 w-60 md:absolute md:top-[-46px] md:end-4">
                        <div>
                            <p className="bg-white uppercase font-bold text-black">ligue para nos</p>
                            <ul className="text-sm ">
                                <li className="bg-white">9999 9999 9999</li>
                                <li className="bg-white">(99) 999999999</li>
                            </ul>
                        </div>
                        <div>
                            <p className="bg-white uppercase font-bold text-black">localização</p>
                            <ul className="text-sm">
                                <li className="bg-white">123 lorem ipsum, 12 lorem</li>
                                <li className="bg-white">Brasil, CE 99999-9999</li>
                            </ul>
                        </div>
                        <div>
                            <p className="bg-white uppercase font-bold text-black">horário comercial</p>
                            <ul className="text-sm">
                                <li className="bg-white">Seg - Sex .... 7h - 17h</li>
                                <li className="bg-white">Sáb ............. 7h - 12h</li>
                            </ul>
                        </div>
                    </div>
                </div>
